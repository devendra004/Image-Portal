                    ...
                    <div class="clearfix sub-header-wrapper">
                        <div class="row">
                            <div class="col-md-9 col-sm-8">
                                <h1 class="admin-page-title">Marketing group</h1>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset>
                                    ...
                                    <input type="text" name="description" placeholder="This is a remark" class="full-input" id="description">
                                </fieldset>
                            </div>
                        </div>
                    ...
                    <div class="general-list-wrapper user-search clearfix">
                        ...
                        <div class="list-header clearfix">
                            ...
                            <div class="search-wrapper pull-right">
                                <input type="search" placeholder="Member..." id="search-group">
                            </div>
                        </div>
                        <div class="general-scroll-wrapper clearfix">
                            <ul class="user-container">
                                ...
                                <li class="clearfix">
                                    ...
                                    <span class="pull-right">
                                        <input type="checkbox" name="general" value="1" id="general-51">
                                        <label for="general-51"></label>
                                    </span>
                                </li>
                                <li class="clearfix">
                                    <div class="pull-left">
