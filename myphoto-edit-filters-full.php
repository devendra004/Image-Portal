...
<div id="wrapper" class="my-photo-edit--wrapper">
    ...
    <section id="section" class="my-photo-edit-wrap">
        ...
        <div class="filter-result-container colored-bg-1">
            ...
            <div class="filter-result-inner-container clearfix">
                <div class="center-container candy-wrapper  my-photo-filters clearfix">

                    <!-- Start filters -->
                    <?php include 'includes/filter.php' ?>
                    <!-- End filters -->

                    <div class="result-inner nested main-part" >
 ...
 <!-- Start result-item -->
                    ...
                    <div class="overlay-wrapper-filterz right-part">
...
<script>
    ...
    $( '.right-part' ).wrap( '<div class="wrap"></div>' ); // wrap it up
    ...
    function measureheight() {
        sidebarheight = $('.right-part').outerHeight() + cushion;
        mainheight = $('.main-part').outerHeight();
