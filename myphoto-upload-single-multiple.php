        ...
        <div class="filter-result-container colored-bg-1">
            ...
            <div class="filter-result-inner-container clearfix">
                <div class="center-container  my-photo-filters clearfix">
                    ...
                    <div class="title-wrapper full-width clearfix">
                        <h1 class="page-title pull-left">Uploading <span>(202 photos)</span></h1>
                    </div>
                    ...
                    <div class="result-inner nested">
                        <div class="float-contaier clearfix">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-4">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-5">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-6">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-7">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-8">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-9">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-10">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-11">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-12">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-13">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-14">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-15">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-16">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-17">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-18">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-19">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-20">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-21">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-22">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-23">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-24">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-25">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- Start result-item -->
                            <div class="result-item nested-item"  id="index-26">
                                <div class="result-item-inner">
                                    <div class="result--inner">
                                        <a href="photo-view.php">
                            ...
                            <!-- End result-item -->
                                        ...
                                        <div class="overlay-wrapper-filter">
                    ...
                    <div class="edit-filter">
                        <form action="#" method="post">
                            ...
                            <div class=" ui-elements">
                                ...
                                <a href="#" class="btn grey-btn"> Delete Selecter (4) </a>
                            </div>
                        </form>
                    </div>
                </div>
